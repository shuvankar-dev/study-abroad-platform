  ...
  return (
    <>
      ...
      <div className="fixed right-6 bottom-6 z-50 flex items-end">
        ...
        <button
          onClick={() => setOpen((s) => !s)}
          aria-label="Open expert bubble"
          className="relative w-14 h-14 md:w-16 md:h-16 rounded-full bg-white/90 backdrop-blur border border-gray-200 shadow-xl flex items-center justify-center focus:outline-none transition-transform hover:scale-105"
        >
